...
public class Extracteur {
    ...
    private boolean extraction(boolean resetting) {
        ...
        for (int i = 0; i < l; i++) {
            ...
            cur_gen_value=0;
            cur_gen_det = false;
//TODO reorganiser le graphe lorsque l'on coupe les genereteurs : creer un nouveau graphe a chaque fois car des aretes disparaissent et des noeuds sont fusionn�s.
